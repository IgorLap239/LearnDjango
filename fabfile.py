...
SUDO_USER_PROD = 'ilaptev'
IP_PROD = '193.168.3.193'
PATH_TO_PROJECT_PROD = './LearnDjango'
PATH_TO_VENV_BIN_PROD = 'venv/bin/'
DATABASE_NAME_PROD = 'learndjango'
DATABASE_USERNAME_PROD = 'ilaptev'
DATABASE_NAME_LOCAL = 'learndjango'
DATABASE_USERNAME_LOCAL = 'ilaptev'
PATH_TO_MEDIA_PROD = './LearnDjango/LearnDjango/media'
PATH_TO_MEDIA_LOCAL = 'LearnDjango/media'
...
def dump_local_db():
    ...
    local(
        'mysqldump --databases ' + DATABASE_NAME_LOCAL + ' > ' + dump_filename + ' -u ' + DATABASE_USERNAME_LOCAL + ' -p')
